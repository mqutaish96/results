...
processor = SimpleProcessor(cpu_type=cpu_type, isa=ISA.X86, num_cores=8)
...
binary = BinaryResource(local_path="/mnt/c/users/uqmqutai/Desktop/study/gem5/fs/no_sharing")
board.set_se_binary_workload(binary, arguments=["-t","w","-n", "2", "-a", "s", "-s", "y"])
